...
<div class="container">
	<div class="dropdown">
		...
		<a href="liste_detail_contac.php">Affichage Detaille</a>
			<a href="liste_contact_nom.php">Affichage Par NOM</a>
			<a href="liste_contact_prenom.php"> AffichagePar Prenom</a>
			<a href="liste_contact_date.php"> AffichagePar Date</a>
...
try {
 ...
 <h1>LISTE  DES  CONTACTS   TRIES PAR PRENOM</h1>
       <?php
